            ...
            <div className="bg-gradient-to-br from-white to-gray-50/50 dark:from-gray-900 dark:to-gray-800/50 rounded-xl p-4 sm:p-6 shadow-lg border-0">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
                ...
                <button 
                  ...
                  className="flex flex-col items-center p-3 sm:p-4 bg-gradient-to-br from-orange-500 to-amber-500 text-white rounded-xl hover:shadow-lg transition-all duration-300 transform hover:scale-105"
                  data-testid="button-test-customer-website"
                >
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-white/20 rounded-xl flex items-center justify-center mb-2 sm:mb-3">
                    <svg className="w-5 h-5 sm:w-6 sm:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-xs sm:text-sm font-medium text-center">Test Customer Menu</span>
                </button>
              </div>
